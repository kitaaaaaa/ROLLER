...
//-------------------------------------------------------------------------------------------------
{
  ...
  .iBoostJumpDrain = 260, .iBoostRegen = 150, .iBoostCrouchRegen = 460,
  ...
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "SCATTER LONG", .byKind = MECHA_PROJ_BULLET,
    ...
    [MECHA_SLOT_CENTER] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "LANCE CHARGE", .byKind = MECHA_PROJ_BEAM,
    ...
    [MECHA_SLOT_RIGHT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "SEED MINE", .byKind = MECHA_PROJ_MINE,
...
//-------------------------------------------------------------------------------------------------
{
  ...
  .iBoostJumpDrain = 330, .iBoostRegen = 130, .iBoostCrouchRegen = 420,
  ...
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "SUPPRESS", .byKind = MECHA_PROJ_BULLET,
    ...
    [MECHA_SLOT_CENTER] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "SIEGE LANCE", .byKind = MECHA_PROJ_BEAM,
        .byCount = 1, .byPalette = PAL_TRACER_WHITE,
    ...
    [MECHA_SLOT_RIGHT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "POD STORM", .byKind = MECHA_PROJ_HOMING,
...
//-------------------------------------------------------------------------------------------------
{
  ...
  .iBoostJumpDrain = 210, .iBoostRegen = 175, .iBoostCrouchRegen = 520,
  ...
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "NEEDLE FOCUS", .byKind = MECHA_PROJ_BEAM,
    ...
    [MECHA_SLOT_CENTER] = {
      [MECHA_STANCE_STAND] = { .szName = "ARC BEAM", .byKind = MECHA_PROJ_BEAM,
        ...
        .fMuzzleHeight = 0.70f, .fMuzzleSide = 0.0f },
      [MECHA_STANCE_CROUCH] = { .szName = "ARC PIERCE", .byKind = MECHA_PROJ_BEAM,
        .byCount = 1, .byPalette = PAL_TRACER_WHITE,
    ...
    [MECHA_SLOT_RIGHT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "TRACKER LOCK", .byKind = MECHA_PROJ_HOMING,
...
//-------------------------------------------------------------------------------------------------
{
  ...
  .iBoostJumpDrain = 240, .iBoostRegen = 160, .iBoostCrouchRegen = 500,
  ...
  .aWeapons = {
    [MECHA_SLOT_LEFT] = {
      [MECHA_STANCE_STAND] = { .szName = "SIDEARM", .byKind = MECHA_PROJ_BULLET,
        ...
        .iRecoveryTicks = 8, .fStagger = 5.0f,
        .fMuzzleHeight = 0.62f, .fMuzzleSide = -1.0f },
      [MECHA_STANCE_CROUCH] = { .szName = "SIDEARM AIMED", .byKind = MECHA_PROJ_BULLET,
    ...
    [MECHA_SLOT_CENTER] = {
      [MECHA_STANCE_STAND] = { .szName = "SABRE SLASH", .byKind = MECHA_PROJ_MELEE,
        ...
        .fMuzzleHeight = 0.60f, .fMuzzleSide = 0.0f },
      [MECHA_STANCE_CROUCH] = { .szName = "SABRE RISE", .byKind = MECHA_PROJ_MELEE,
        .byCount = 1, .byPalette = PAL_TRACER_WHITE,
    ...
    [MECHA_SLOT_RIGHT] = {
      ...
      [MECHA_STANCE_CROUCH] = { .szName = "TRIP MINE", .byKind = MECHA_PROJ_MINE,
